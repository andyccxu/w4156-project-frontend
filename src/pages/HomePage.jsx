                        ...
                        <>
                            {
                                schedules.map((schedule, index) => {
                                    ...
                                    return (
                                        <div key={index} className="border-2 border-gray-200 rounded-md p-2 mb-4">
                                            <div className="font-bold text-lg mb-2">{schedule._id}</div>
                                            <div className="text-sm mb-2">{schedule.dateGenerated}</div>
                                            ...
                                            <div className="grid grid-cols-2 gap-2">
                                                {schedule.shifts.map((shift, index) => {
                                                    return (
                                                        <div key={index} className="border-2 border-gray-200 rounded-md p-2 mb-2">
